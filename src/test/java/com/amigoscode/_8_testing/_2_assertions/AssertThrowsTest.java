...
class AssertThrowsTest {
    ...
    @Test
    void exceptionMessageContainExpectedText(){
        Exception exception =  assertThrows(NumberFormatException.class, () -> Integer.parseInt("abc"));
    ...
    //  });
    @Test
    void customExceptionThrowsIllegalStateException(){

...
public class StringMethods {
    ...
    public static String searchString(String text, String keyword) {
        ...
        boolean check = text.contains(keyword);
        return "contains: " + check + ", indexOf: " + index;
    }
    ...
    public static String replaceDemo(String text, String oldWord, String newWord) {
        ...
        String replacement = text.replace(oldWord,newWord);
        text = replacement.replaceAll("\\d", "#");
        return text;
    }
    ...
    public static String splitDemo(String text, String delimiter) {
        ...
        for(int i = 0; i<parts.length; i++){
            if(i < parts.length-1){
                result.append("[").append(i).append("]").append(" ").append(parts[i]).append("\n");
            }else {
                result.append("[").append(i).append("]").append(" ").append(parts[i]);
            }
        }
    ...
    public static String checkStartEnd(String filename, String prefix, String extension) {
        ...
        boolean checkPrefix = filename.startsWith(prefix);
        boolean checkExtension = filename.endsWith(extension);
        return  "startsWith "+"'"+prefix+"': "+checkPrefix+" , endsWith "+"'"+extension+"': "+checkExtension;
    }

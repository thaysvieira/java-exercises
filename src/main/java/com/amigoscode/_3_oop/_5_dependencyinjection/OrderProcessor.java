...
//   In charge(), print "[Stripe] Charging $<amount>" and return true.
    ...
    class StripeGateway implements  PaymentGateway{
        ...
        public boolean charge(double amount) {
            System.out.println(StripeGateway.class.getName()+" Charging $"+amount);
            return true;
        }
    }
...
//   In save(), print "[Repository] Order saved: <order>"
    ...
    class InMemoryOrderRepository implements OrderRepository{
        ...
        public void save(Order order) {
            System.out.println(OrderRepository.class.getName()+" Order saved: "+order);
        }
    }
...
class OrderProcessorDemo {
    public static void main(String[] args) {
        ...
        InMemoryOrderRepository memoryOrderRepository = new InMemoryOrderRepository();
        OrderProcessor orderProcessor = new OrderProcessor(stripeGateway, memoryOrderRepository);

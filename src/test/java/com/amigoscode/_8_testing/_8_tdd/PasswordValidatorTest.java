...
class PasswordValidatorTest {
    ...
    @Test
    void verifyingPasswordAtLeastOneUpperCaseLetter(){
    ...
    @Test
    void verifyingPasswordAtLeastOneLowerCaseLetter(){
        assertFalse(passwordValidator.isValid("ABCDEFG1!"));
    }
    ...
    @Test
    void verifyingPasswordAtLeastOneDigit(){
    ...
    @Test
    void verifyingPasswordAtLeastSpecialChar(){
        assertFalse(passwordValidator.isValid("Abcdefg1"));
    }
    ...
    @ParameterizedTest
    @CsvSource({"Password1!,true",
                 "Str0ng@Pass,true",
                 "MyP@ssw0rd,true"})
    void verifyingFullyPass(String pass){

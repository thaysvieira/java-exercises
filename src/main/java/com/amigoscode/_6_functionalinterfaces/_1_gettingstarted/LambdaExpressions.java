...
public class LambdaExpressions {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BiFunction<Integer, Integer, Integer> sumShort = Integer::sum;
        ...
        BiFunction<String, String,String> name = String::concat;
        System.out.println(name.apply("Hello ","+ World"));
        ...
        java.util.function.Function<String, String> exclaim = s -> s.concat("!");
        ...
        System.out.println(processName("thays",String::toUpperCase));

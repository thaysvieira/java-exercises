...
public class Pair<K, V> {
    ...
    public Pair<V, K> swap(V value,K key){
    ...
    public static void main(String[] args) {
        ...
        Pair<String,Integer> john = new Pair<>("Alice",30);

        System.out.println(john.swap(john.getValue(),john.getKey()));
        Pair<String,Integer> marie = new Pair<>("John",32);
        System.out.println(marie.swap(marie.getValue(),marie.getKey()));
        System.out.println(john.getKey().equals(marie.getKey()));
        System.out.println(john.getValue().equals(marie.getValue()));
    }
}

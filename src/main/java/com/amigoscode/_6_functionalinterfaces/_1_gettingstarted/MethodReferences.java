...
public class MethodReferences {
    ...
    public static void main(String[] args) {
        ...
        Function<Integer, String> integerString = Object::toString;
        integerString.apply(42);
        ...
        Function<String, Integer> lambdas = s -> s.length();
        System.out.println(lambdas.apply("Hello"));
        Function<String, Integer> reference = String::length;
        System.out.println(reference.apply("Hello"));

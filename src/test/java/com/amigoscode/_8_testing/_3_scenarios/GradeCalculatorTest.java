...
class GradeCalculatorTest {
    ...
    void throwsIllegalArgumentException(){
        assertThrows(IllegalArgumentException.class,()->gradeCalculator.calculateGrade(-1));
    }
    ...
    @Test
    void scoreGreaterThan100throwsIllegalArgumentException(){

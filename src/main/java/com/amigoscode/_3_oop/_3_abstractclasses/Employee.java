...
abstract class Employee {
    ...
    public String getDetails(){
        return String.format("%.2f", calculatePay());
    }
}
...
//   - Implement calculatePay() to return hourlyRate * hoursWorked
    ...
    public ContractEmployee(String name, double baseSalary, double hourlyRate, int hoursWorked) {
        super(name, baseSalary);
...
class EmployeeDemo {
    public static void main(String[] args) {
        ...
        List<Employee> employees = List.of(new FullTimeEmployee("Jhonny",2_300),new ContractEmployee("Marie",3_000,40,8));

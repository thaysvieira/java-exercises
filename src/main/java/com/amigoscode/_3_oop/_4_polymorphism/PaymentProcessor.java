...
class BankTransferPayment implements Payment {
    ...
    @Override
    public boolean processPayment(double amount) {
        System.out.println("Processing BankTransfer payment of $" + amount + " from " + bankAccountId);
        return true;
    }
...
class PaymentDemo {
    public static void main(String[] args) {
        ...
        List<Payment> payments = List.of(
                new CreditCardPayment("123-123-123"),
                new PayPalPayment("client@gmail.com"),
                new BankTransferPayment("00033")
        );
        PaymentProcessor processor = new PaymentProcessor();
        processor.processAllPayments(payments, 2_000);
        ...
        payment = new BankTransferPayment("78787-5678");
        payment.processPayment(390.0);

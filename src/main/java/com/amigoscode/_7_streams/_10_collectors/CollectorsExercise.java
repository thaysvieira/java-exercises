...
public class CollectorsExercise {
    ...
    public static void main(String[] args) {
        ...
        List<String> unmodifiable = names.stream().toList();
        System.out.println(unmodifiable);
        // TODO: 2 - Collect 'people' to a Map where key is name and value is age
        //           Use Collectors.toMap(Person::name, Person::age)
        //           Print the resulting map
        Map<String, Integer> map = people.stream().collect(Collectors.toMap(Person::name, Person::age));
        ...
        //           Print the result
        Map<String, String> listNoDuplicate = peopleWithDuplicateCities.stream().collect(Collectors.toMap(Person::city, Person::name, (name1, name2) -> name1 + ", " + name2));
        ...
        ConcurrentMap<String, String> basedNameCity = people.stream().collect(Collectors.toConcurrentMap(Person::name, Person::city));
        System.out.println(basedNameCity);
        ...
        //           Print the result
        Integer collect = names.stream().collect(Collectors.collectingAndThen(Collectors.toList(), List::size));
        ...
        double avg = numbers.stream().collect(Collectors.teeing(Collectors.summingInt(Integer::intValue), Collectors.counting()

...
public class ClassesAndObjects {
    ...
    public static void main(String[] args) {
        ...
        ClassesAndObjects.Person alice = new ClassesAndObjects.Person("Alice",30);
        ClassesAndObjects.Person pedro = new ClassesAndObjects.Person();
        ClassesAndObjects.Person sameAlice = new ClassesAndObjects.Person("Alice",30);
        //  Print all three using System.out.println() (which calls toString()).
        System.out.println(alice.toString());
        System.out.println(pedro.toString());
        System.out.println(sameAlice.toString());
        //  Test equals(): compare person1 with person3 (should be true),
        System.out.println("Test equals(): compare person1 with person3 (should be true) -->"+alice.equals(sameAlice));
        //  and person1 with person2 (should be false).
        System.out.println("Test equals(): and person1 with person2 (should be false) -->"+alice.equals(pedro));
        ...
        //When a constructor calls another constructor in the same class using this(...). It avoids duplicating initialization logic
        //  Print: "No-args person: " + the no-args person to show the defaults.
        System.out.println( "No-args person: " +pedro);

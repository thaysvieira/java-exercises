...
class PersonTest {
    ...
    @Test
    void ageComparisons(){
        assertThat(alice.getAge()).isGreaterThan(bob.getAge());
    }
    ...
    @Test
    void validateEmail(){
        assertTrue(alice.getEmail().contains("@"));
        assertTrue(alice.getEmail().endsWith("example.com"));
        assertTrue(alice.getEmail().startsWith("alice"));
    ...
    void validateList(){
        ...
        assertFalse(people.contains(new Person("Dave", 40, "dave@example.com")));

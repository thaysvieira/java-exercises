...
public class HashMapExercises {
    ...
    public static void main(String[] args) {
        ...
        for(Map.Entry<String, Integer> setStudent: studentGrades.entrySet()){
            System.out.println("Student: "+setStudent.getKey()+", Grade: "+setStudent.getValue());
        }
        ...
        //           Then iterate over just the values using values() and print them
            for(String setStudent: studentGrades.keySet()){
            System.out.println(setStudent);
        }
        for(Integer setStudent: studentGrades.values()){
            System.out.println(setStudent);
        }
    }
}
